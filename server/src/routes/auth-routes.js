...
var login = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, passwordIsValid, secretKey, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                token = jsonwebtoken_1.default.sign({ userId: user.id, email: user.email }, secretKey, { expiresIn: '1h' });
