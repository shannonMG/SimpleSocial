...
var getPostById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, post_1.Post.findByPk(id, {
                        include: [
                            {
                                model: circle_js_1.Circle,
                                as: 'circle_id', // This should match the alias defined in the association
...
var createPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user_id, circle_id, content, newPost, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, user_id = _a.user_id, circle_id = _a.circle_id, content = _a.content;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, post_1.Post.create({ user_id: user_id, circle_id: circle_id, content: content })];
            case 2:
                newPost = _b.sent();
...
var updatePost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, user_id, circle_id, content, post, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
